...
namespace ClientExtended.External
{
    public static class World
    {
        ...
        public static TimeSpan CurrentTime
        {
            ...
            set => Function.Call((Hash)0x669E223E64B1903C, value.Hours, value.Minutes, value.Seconds);
        }
        ...
        {
            var handle = Function.Call<int>(Hash._PROMPT_CREATE, control, Function.Call<long>(Hash._CREATE_VAR_STRING, 10, "LITERAL_STRING", text), 6, 1, 1, -1);
            ...
            Function.Call(Hash._PROMPT_SET_ENABLED, prompt.Handle, false);
            Function.Call(Hash._PROMPT_SET_VISIBLE, prompt.Handle, false);
            Function.Call(Hash._PROMPT_SET_STANDARDIZED_HOLD_MODE, prompt.Handle, 100);
            return prompt;
        }

        public static Blip CreateBlip(string name, Vector3 position, BlipSprite sprite, BlipType type)
        {
            var blip = Function.Call<int>((Hash)0x554d9d53f696d002, type, position.X, position.Y, position.Z);
            Function.Call(Hash.SET_BLIP_SPRITE, blip, sprite, 1);
            Function.Call((Hash)0x9CB1A1623062F402, blip, name);
        ...
        public static async Task<Ped> CreatePed(Model model, Vector3 position, float heading = 0f, bool isNet = true, bool isMission = true)
        {
            ...
            var id = API.CreatePed((uint)model.Hash, position.X, position.Y, position.Z, heading,
                isNet, !isMission, false, false);
