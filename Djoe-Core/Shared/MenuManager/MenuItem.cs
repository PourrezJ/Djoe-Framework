...
namespace Shared.MenuManager
{
    ...
    {
        #region Delegates
        public delegate Task OnMenuItemCallBackDelegateAsync(Player client, Menu menu = null, IMenuItem menuItem = null, int itemIndex = 0);
        public delegate void OnMenuItemCallBackDelegate(Player client, Menu menu = null, IMenuItem menuItem = null, int itemIndex = 0);
        #endregion
